---
title: "Gemma 4 on Amazon SageMaker: QAT Weights Decode 2.05x Faster Than bf16 on One L4"
published: false
...
| `-qat-q4_0-unquantized` | ⚠️ stored at 16-bit, no memory saving |
...
| --- | ---: | ---: | ---: |
| 876 + 608 − 558 | 926 | ❌ 1026 | ✅ 926 |
| 257 + 388 − 290 | 355 | ✅ 355 | ❌ 655 |
| 782 + 571 − 534 | 819 | ❌ 829 | ✅ 819 |
| 470 + 238 − 983 | −275 | ✅ −275 | ❌ −285 |
| 150 + 937 − 139 | 948 | ❌ 918 | ❌ 1010 |
...
```plaintext
🗑️ `gemma-4-e2b-qat` in `us-east-2`
- endpoint: deleted
...
- ⚠️ The 4-bit export saves 18% of weight memory, because the embeddings stay at 16-bit
- ⚠️ Getting an L4 took three regions: `us-east-1` and `us-west-2` returned `InsufficientInstanceCapacity` after about 30 minutes each
