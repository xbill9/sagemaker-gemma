...
- L4 capacity varied by region: `us-east-1` refused twice, about 30 minutes each, while `us-east-2` placed an instance at once
- A fallback list holds quota for every type in it
